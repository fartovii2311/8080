...
if (!fs.existsSync(`./Хищник/${conn.user.jid.split`@`[0]}/creds.json`)) {
...
const path = conn.user.jid != global.conn.user.jid ? `./Хищник/${conn.user.jid.split`@`[0]}/creds.json` : `./GataBotSession/creds.json`
